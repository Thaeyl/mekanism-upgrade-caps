...
The NeoForge build uses the configured 1.21.1 instance. The Forge builds compile against the local CurseForge library cache plus each target pack's Mekanism jar so command and mixin signatures match the tested runtimes.
