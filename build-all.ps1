...
$Libraries = if ($env:CURSEFORGE_MINECRAFT_LIBRARIES) {
    ...
    throw 'Set $env:CURSEFORGE_MINECRAFT_LIBRARIES to your Minecraft libraries directory before running this build.'
}
$Instance = if ($env:MC_INSTANCE_DIR) {
    $env:MC_INSTANCE_DIR
} else {
    throw 'Set $env:MC_INSTANCE_DIR to your 1.21.1 NeoForge instance directory before running this build.'
}
...
function Resolve-EnvPath {
    ...
    if (!$value) {
        throw "Set `$env:$Name to the required local path before running this build."
    }
    $value
}
...
Build-NeoForge1211
Build-LegacyForge '1.20.1' '47.4.0' '1.20.1-20230612.114412' (Resolve-EnvPath 'MEKANISM_1_20_1_JAR') '[47,)' '10.4.15' 15
Build-LegacyForge '1.19.2' '43.2.14' '1.19.2-20220805.130853' (Resolve-EnvPath 'MEKANISM_1_19_2_JAR') '[43,)' '10.3.9' 10
Build-LegacyForge '1.18.2' '40.2.17' '1.18.2-20220404.173914' (Resolve-EnvPath 'MEKANISM_1_18_2_JAR') '[40,)' '10.2.5' 9
